...
#define __PYX_HAVE__growcut3D___growcut3D_cy
#define __PYX_HAVE_API__growcut3D___growcut3D_cy
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
#define __pyx_memoryview_copy_slice_d_d_d_dc_double_c(slice)\
        __pyx_memoryview_copy_new_contig(&slice, "c", 4,\
                                         sizeof(double), (PyBUF_C_CONTIGUOUS | PyBUF_FORMAT | PyBUF_WRITABLE),\
                                         0)

/* CopyContentsUtility.proto */
#define __pyx_memoryview_copy_slice_dcd_d_d__double_f(slice)\
        __pyx_memoryview_copy_new_contig(&slice, "fortran", 4,\
...
/* Module declarations from 'growcut3D._growcut3D_cy' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static double __pyx_v_9growcut3D_13_growcut3D_cy_s3;
...
static CYTHON_INLINE double __pyx_f_9growcut3D_13_growcut3D_cy_distance(__Pyx_memviewslice, Py_ssize_t, Py_ssize_t, Py_ssize_t, Py_ssize_t, Py_ssize_t, Py_ssize_t); /*proto*/
static CYTHON_INLINE double __pyx_f_9growcut3D_13_growcut3D_cy_g(double); /*proto*/
static struct __pyx_array_obj *__pyx_array_new(PyObject *, Py_ssize_t, char *, char *, char *); /*proto*/
...
#define __Pyx_MODULE_NAME "growcut3D._growcut3D_cy"
int __pyx_module_is_main_growcut3D___growcut3D_cy = 0;

/* Implementation of 'growcut3D._growcut3D_cy' */
...
static const char __pyx_k_growcut3D__growcut3D_cy[] = "growcut3D._growcut3D_cy";
...
static const char __pyx_k_C_Users_Edson_Cavalcanti_Dropbox[] = "C:\\Users\\Edson Cavalcanti\\Dropbox\\Lung\\_growcut3D_cython\\growcut3D\\_growcut3D_cy.pyx";
...
static PyObject *__pyx_kp_s_C_Users_Edson_Cavalcanti_Dropbox;
...
static PyObject *__pyx_n_s_growcut3D__growcut3D_cy;
...
static PyObject *__pyx_pf_9growcut3D_13_growcut3D_cy_growcut3D(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_image, PyObject *__pyx_v_state, int __pyx_v_max_iter, int __pyx_v_window_size); /* proto */
...
/* "growcut3D/_growcut3D_cy.pyx":19
 * 
 * 
...
static CYTHON_INLINE double __pyx_f_9growcut3D_13_growcut3D_cy_distance(__Pyx_memviewslice __pyx_v_image, Py_ssize_t __pyx_v_r0, Py_ssize_t __pyx_v_c0, Py_ssize_t __pyx_v_s0, Py_ssize_t __pyx_v_r1, Py_ssize_t __pyx_v_c1, Py_ssize_t __pyx_v_s1) {
  double __pyx_v_s;
  double __pyx_v_d;
  int __pyx_v_i;
  double __pyx_r;
  ...
  /* "growcut3D/_growcut3D_cy.pyx":23
 *                             Py_ssize_t r1, Py_ssize_t c1, Py_ssize_t s1,) nogil:
 *     cdef:
 *         double s = 0, d             # <<<<<<<<<<<<<<
 *         int i
 ...
 */
  ...
  /* "growcut3D/_growcut3D_cy.pyx":26
 *         int i
 * 
 *     for i in range(3):             # <<<<<<<<<<<<<<
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 3; __pyx_t_1+=1) {
    ...
    /* "growcut3D/_growcut3D_cy.pyx":27
 * 
 *     for i in range(3):
 *         d = image[r0, c0, s0, i] - image[r1, c1, s1, i]             # <<<<<<<<<<<<<<
 *         s += d * d
 ...
 */
    ...
    __pyx_t_8 = __pyx_v_s1;
    __pyx_t_9 = __pyx_v_i;
    __pyx_v_d = ((*((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_2 * __pyx_v_image.strides[0]) ) + __pyx_t_3 * __pyx_v_image.strides[1]) ) + __pyx_t_4 * __pyx_v_image.strides[2]) )) + __pyx_t_5)) ))) - (*((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_6 * __pyx_v_image.strides[0]) ) + __pyx_t_7 * __pyx_v_image.strides[1]) ) + __pyx_t_8 * __pyx_v_image.strides[2]) )) + __pyx_t_9)) ))));

    /* "growcut3D/_growcut3D_cy.pyx":28
 *     for i in range(3):
 *         d = image[r0, c0, s0, i] - image[r1, c1, s1, i]
 *         s += d * d             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "growcut3D/_growcut3D_cy.pyx":30
 *         s += d * d
 * 
 *     return sqrt(s)             # <<<<<<<<<<<<<<
 * 
...
/* "growcut3D/_growcut3D_cy.pyx":36
 * 
 * 
...
static CYTHON_INLINE double __pyx_f_9growcut3D_13_growcut3D_cy_g(double __pyx_v_d) {
  double __pyx_r;

  /* "growcut3D/_growcut3D_cy.pyx":37
 * 
 * cdef inline double g(double d) nogil:
 *     return 1 - (d / s3) * (d / s3)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_r = (1.0 - ((__pyx_v_d / __pyx_v_9growcut3D_13_growcut3D_cy_s3) * (__pyx_v_d / __pyx_v_9growcut3D_13_growcut3D_cy_s3)));
  goto __pyx_L0;
...
/* "growcut3D/_growcut3D_cy.pyx":40
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_9growcut3D_13_growcut3D_cy_1growcut3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9growcut3D_13_growcut3D_cy_growcut3D[] = "Grow-cut segmentation.\n\n    Parameters\n    ----------\n    image : (M, N) ndarray\n        Input image.\n    state : (M, N, 2) ndarray\n        Initial state, which stores (foreground/background, strength) for\n        each pixel position or automaton.  The strength represents the\n        certainty of the state (e.g., 1 is a hard seed value that remains\n        constant throughout segmentation).\n    max_iter : int, optional\n        The maximum number of automata iterations to allow.  The segmentation\n        may complete earlier if the state no longer varies.\n    window_size : int\n        Size of the neighborhood window.\n\n    Returns\n    -------\n    mask : ndarray\n        Segmented image.  A value of zero indicates background, one foreground.\n\n    ";
static PyMethodDef __pyx_mdef_9growcut3D_13_growcut3D_cy_1growcut3D = {"growcut3D", (PyCFunction)__pyx_pw_9growcut3D_13_growcut3D_cy_1growcut3D, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9growcut3D_13_growcut3D_cy_growcut3D};
static PyObject *__pyx_pw_9growcut3D_13_growcut3D_cy_1growcut3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_state)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("growcut3D", 0, 2, 4, 1); __PYX_ERR(0, 40, __pyx_L3_error)
        }
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "growcut3D") < 0)) __PYX_ERR(0, 40, __pyx_L3_error)
      }
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("growcut3D", 0, 2, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 40, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("growcut3D._growcut3D_cy.growcut3D", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9growcut3D_13_growcut3D_cy_growcut3D(__pyx_self, __pyx_v_image, __pyx_v_state, __pyx_v_max_iter, __pyx_v_window_size);
...
static PyObject *__pyx_pf_9growcut3D_13_growcut3D_cy_growcut3D(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_image, PyObject *__pyx_v_state, int __pyx_v_max_iter, int __pyx_v_window_size) {
  ...
  /* "growcut3D/_growcut3D_cy.pyx":72
 ...
 */
  ...
  __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_img_as_float); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 72, __pyx_L1_error)
  ...
  if (!__pyx_t_5) {
    __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_v_image); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 72, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
  } else {
  ...
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_d_d_d_dc_double(__pyx_t_1);
  if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_image_arr = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "growcut3D/_growcut3D_cy.pyx":73
 * 
 *     image_arr = np.ascontiguousarray(img_as_float(image))
 *     state_arr = state             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_d_d_d_dc_double(__pyx_v_state);
  if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 73, __pyx_L1_error)
  __pyx_v_state_arr = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "growcut3D/_growcut3D_cy.pyx":75
 *     state_arr = state
 * 
 *     height, width, depth = image.shape[0], image.shape[1], image.shape[2]             # <<<<<<<<<<<<<<
 *     ws = (window_size - 1) // 2
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_8 = __Pyx_PyIndex_AsSsize_t(__pyx_t_3); if (unlikely((__pyx_t_8 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_9 = __Pyx_PyIndex_AsSsize_t(__pyx_t_1); if (unlikely((__pyx_t_9 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_image, __pyx_n_s_shape); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_t_1, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_10 = __Pyx_PyIndex_AsSsize_t(__pyx_t_3); if (unlikely((__pyx_t_10 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_height = __pyx_t_8;
  __pyx_v_width = __pyx_t_9;
  __pyx_v_depth = __pyx_t_10;

  /* "growcut3D/_growcut3D_cy.pyx":76
 * 
 *     height, width, depth = image.shape[0], image.shape[1], image.shape[2]
 *     ws = (window_size - 1) // 2             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "growcut3D/_growcut3D_cy.pyx":78
 *     ws = (window_size - 1) // 2
 * 
 *     changes = 1             # <<<<<<<<<<<<<<
 *     changes_per_cell = 0
 ...
 */
  ...
  /* "growcut3D/_growcut3D_cy.pyx":79
 * 
 *     changes = 1
 *     changes_per_cell = 0             # <<<<<<<<<<<<<<
 *     n = 0
 ...
 */
  ...
  /* "growcut3D/_growcut3D_cy.pyx":80
 *     changes = 1
 *     changes_per_cell = 0
 *     n = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "growcut3D/_growcut3D_cy.pyx":82
 *     n = 0
 * 
 *     state_next_arr = state_arr.copy()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_7 = __pyx_memoryview_copy_slice_d_d_d_dc_double_c(__pyx_v_state_arr); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 82, __pyx_L1_error)
  __pyx_v_state_next_arr = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "growcut3D/_growcut3D_cy.pyx":84
 *     state_next_arr = state_arr.copy()
 * 
 *     while changes > 0 and n < max_iter:             # <<<<<<<<<<<<<<
 *         changes = 0
 ...
 */
  while (1) {
    __pyx_t_12 = ((__pyx_v_changes > 0) != 0);
    if (__pyx_t_12) {
    } else {
    ...
    /* "growcut3D/_growcut3D_cy.pyx":85
 * 
 *     while changes > 0 and n < max_iter:
 *         changes = 0             # <<<<<<<<<<<<<<
 *         n += 1
 ...
 */
    ...
    /* "growcut3D/_growcut3D_cy.pyx":86
 *     while changes > 0 and n < max_iter:
 *         changes = 0
 *         n += 1             # <<<<<<<<<<<<<<
 *         print n
 ...
 */
    ...
    /* "growcut3D/_growcut3D_cy.pyx":87
 *         changes = 0
 *         n += 1
 *         print n             # <<<<<<<<<<<<<<
 *         if n % 10 == 0:
 *             print n
 */
    __pyx_t_3 = PyInt_FromSsize_t(__pyx_v_n); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 87, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    if (__Pyx_PrintOne(0, __pyx_t_3) < 0) __PYX_ERR(0, 87, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

    /* "growcut3D/_growcut3D_cy.pyx":88
 *         n += 1
 *         print n
 *         if n % 10 == 0:             # <<<<<<<<<<<<<<
 *             print n
 * 
 */
    __pyx_t_11 = (((__pyx_v_n % 10) == 0) != 0);
    if (__pyx_t_11) {

      /* "growcut3D/_growcut3D_cy.pyx":89
 *         print n
 *         if n % 10 == 0:
 *             print n             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_3 = PyInt_FromSsize_t(__pyx_v_n); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 89, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
 ...
 */
    ...
    /* "growcut3D/_growcut3D_cy.pyx":91
 *             print n
 * 
 *         for k in range(depth):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_10; __pyx_t_9+=1) {
      ...
      /* "growcut3D/_growcut3D_cy.pyx":92
 * 
 *         for k in range(depth):
 *             for j in range(width):             # <<<<<<<<<<<<<<
 *                 for i in range(height):
 ...
 */
      ...
      for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_8; __pyx_t_13+=1) {
        ...
        /* "growcut3D/_growcut3D_cy.pyx":93
 *         for k in range(depth):
 *             for j in range(width):
 *                 for i in range(height):             # <<<<<<<<<<<<<<
 *                     changes_per_cell = 0
 ...
 */
        ...
        for (__pyx_t_15 = 0; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
          ...
          /* "growcut3D/_growcut3D_cy.pyx":94
 *             for j in range(width):
 *                 for i in range(height):
 *                     changes_per_cell = 0             # <<<<<<<<<<<<<<
 *                     for kk in xrange(max(0, k - ws), min(k + ws + 1, depth)):
 ...
 */
          ...
          /* "growcut3D/_growcut3D_cy.pyx":95
 *                 for i in range(height):
 *                     changes_per_cell = 0
 *                     for kk in xrange(max(0, k - ws), min(k + ws + 1, depth)):             # <<<<<<<<<<<<<<
 *                         for jj in xrange(max(0, j - ws), min(j + ws + 1, width)):
 ...
 */
          ...
          __pyx_t_17 = ((__pyx_v_k + __pyx_v_ws) + 1);
          ...
          __pyx_t_18 = (__pyx_v_k - __pyx_v_ws);
          __pyx_t_19 = 0;
          ...
          for (__pyx_t_18 = __pyx_t_17; __pyx_t_18 < __pyx_t_16; __pyx_t_18+=1) {
            ...
            /* "growcut3D/_growcut3D_cy.pyx":96
 *                     changes_per_cell = 0
 *                     for kk in xrange(max(0, k - ws), min(k + ws + 1, depth)):
 *                         for jj in xrange(max(0, j - ws), min(j + ws + 1, width)):             # <<<<<<<<<<<<<<
 *                             for ii in xrange(max(0, i - ws), min(i + ws + 1, height)):
 ...
 */
            ...
            __pyx_t_21 = ((__pyx_v_j + __pyx_v_ws) + 1);
            ...
            __pyx_t_22 = (__pyx_v_j - __pyx_v_ws);
            __pyx_t_19 = 0;
            ...
            for (__pyx_t_22 = __pyx_t_21; __pyx_t_22 < __pyx_t_20; __pyx_t_22+=1) {
              ...
              /* "growcut3D/_growcut3D_cy.pyx":97
 *                     for kk in xrange(max(0, k - ws), min(k + ws + 1, depth)):
 *                         for jj in xrange(max(0, j - ws), min(j + ws + 1, width)):
 *                             for ii in xrange(max(0, i - ws), min(i + ws + 1, height)):             # <<<<<<<<<<<<<<
 *                                 if ii == i and jj == j and kk == k or changes_per_cell > 0:
 ...
 */
              ...
              __pyx_t_24 = ((__pyx_v_i + __pyx_v_ws) + 1);
              ...
              __pyx_t_25 = (__pyx_v_i - __pyx_v_ws);
              __pyx_t_19 = 0;
              if (((__pyx_t_25 > __pyx_t_19) != 0)) {
              ...
              for (__pyx_t_25 = __pyx_t_24; __pyx_t_25 < __pyx_t_23; __pyx_t_25+=1) {
                ...
                /* "growcut3D/_growcut3D_cy.pyx":98
 *                         for jj in xrange(max(0, j - ws), min(j + ws + 1, width)):
 *                             for ii in xrange(max(0, i - ws), min(i + ws + 1, height)):
 *                                 if ii == i and jj == j and kk == k or changes_per_cell > 0:             # <<<<<<<<<<<<<<
 *                                     continue
 * 
 */
                __pyx_t_12 = ((__pyx_v_ii == __pyx_v_i) != 0);
                if (!__pyx_t_12) {
                  goto __pyx_L22_next_or;
                } else {
                }
                __pyx_t_12 = ((__pyx_v_jj == __pyx_v_j) != 0);
                if (!__pyx_t_12) {
                  goto __pyx_L22_next_or;
                } else {
                }
                __pyx_t_12 = ((__pyx_v_kk == __pyx_v_k) != 0);
                if (!__pyx_t_12) {
                } else {
                  __pyx_t_11 = __pyx_t_12;
                ...
                __pyx_L22_next_or:;
                __pyx_t_12 = ((__pyx_v_changes_per_cell > 0) != 0);
                __pyx_t_11 = __pyx_t_12;
                __pyx_L21_bool_binop_done:;
                if (__pyx_t_11) {

                  /* "growcut3D/_growcut3D_cy.pyx":99
 *                             for ii in xrange(max(0, i - ws), min(i + ws + 1, height)):
 *                                 if ii == i and jj == j and kk == k or changes_per_cell > 0:
 *                                     continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
                ...
                /* "growcut3D/_growcut3D_cy.pyx":104
 *                                 # q -> attacker, (ii, jj)
 * 
 ...
 */
                __pyx_v_gc = __pyx_f_9growcut3D_13_growcut3D_cy_g(__pyx_f_9growcut3D_13_growcut3D_cy_distance(__pyx_v_image_arr, __pyx_v_i, __pyx_v_j, __pyx_v_k, __pyx_v_ii, __pyx_v_jj, __pyx_v_kk));

                /* "growcut3D/_growcut3D_cy.pyx":106
 *                                 gc = g(distance(image_arr, i, j, k, ii, jj, kk))
 * 
 *                                 attack_strength = gc * state_arr[ii, jj, kk, 1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
                ...
                __pyx_t_29 = 1;
                __pyx_v_attack_strength = (__pyx_v_gc * (*((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_arr.data + __pyx_t_26 * __pyx_v_state_arr.strides[0]) ) + __pyx_t_27 * __pyx_v_state_arr.strides[1]) ) + __pyx_t_28 * __pyx_v_state_arr.strides[2]) )) + __pyx_t_29)) ))));

                /* "growcut3D/_growcut3D_cy.pyx":108
 *                                 attack_strength = gc * state_arr[ii, jj, kk, 1]
 * 
 *                                 if attack_strength > state_arr[i, j, k, 1]:             # <<<<<<<<<<<<<<
 ...
 */
                ...
                __pyx_t_33 = 1;
                __pyx_t_11 = ((__pyx_v_attack_strength > (*((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_arr.data + __pyx_t_30 * __pyx_v_state_arr.strides[0]) ) + __pyx_t_31 * __pyx_v_state_arr.strides[1]) ) + __pyx_t_32 * __pyx_v_state_arr.strides[2]) )) + __pyx_t_33)) )))) != 0);
                if (__pyx_t_11) {

                  /* "growcut3D/_growcut3D_cy.pyx":109
 * 
 *                                 if attack_strength > state_arr[i, j, k, 1]:
 *                                     state_next_arr[i, j, k, 1] = attack_strength             # <<<<<<<<<<<<<<
 * 
 ...
 */
                  ...
                  __pyx_t_37 = 1;
                  *((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_next_arr.data + __pyx_t_34 * __pyx_v_state_next_arr.strides[0]) ) + __pyx_t_35 * __pyx_v_state_next_arr.strides[1]) ) + __pyx_t_36 * __pyx_v_state_next_arr.strides[2]) )) + __pyx_t_37)) )) = __pyx_v_attack_strength;

                  /* "growcut3D/_growcut3D_cy.pyx":111
 *                                     state_next_arr[i, j, k, 1] = attack_strength
 * 
 *                                     if state_arr[i, j, k, 0] != state_arr[ii, jj, kk, 0]:             # <<<<<<<<<<<<<<
 ...
 */
                  ...
                  __pyx_t_45 = 0;
                  __pyx_t_11 = (((*((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_arr.data + __pyx_t_38 * __pyx_v_state_arr.strides[0]) ) + __pyx_t_39 * __pyx_v_state_arr.strides[1]) ) + __pyx_t_40 * __pyx_v_state_arr.strides[2]) )) + __pyx_t_41)) ))) != (*((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_arr.data + __pyx_t_42 * __pyx_v_state_arr.strides[0]) ) + __pyx_t_43 * __pyx_v_state_arr.strides[1]) ) + __pyx_t_44 * __pyx_v_state_arr.strides[2]) )) + __pyx_t_45)) )))) != 0);
                  if (__pyx_t_11) {

                    /* "growcut3D/_growcut3D_cy.pyx":112
 * 
 *                                     if state_arr[i, j, k, 0] != state_arr[ii, jj, kk, 0]:
 *                                         state_next_arr[i, j, k, 0] = state_arr[ii, jj, kk, 0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
                    ...
                    __pyx_t_48 = __pyx_v_kk;
                    __pyx_t_49 = 0;
                    __pyx_t_50 = __pyx_v_i;
                    __pyx_t_51 = __pyx_v_j;
                    __pyx_t_52 = __pyx_v_k;
                    __pyx_t_53 = 0;
                    *((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_next_arr.data + __pyx_t_50 * __pyx_v_state_next_arr.strides[0]) ) + __pyx_t_51 * __pyx_v_state_next_arr.strides[1]) ) + __pyx_t_52 * __pyx_v_state_next_arr.strides[2]) )) + __pyx_t_53)) )) = (*((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_arr.data + __pyx_t_46 * __pyx_v_state_arr.strides[0]) ) + __pyx_t_47 * __pyx_v_state_arr.strides[1]) ) + __pyx_t_48 * __pyx_v_state_arr.strides[2]) )) + __pyx_t_49)) )));

                    /* "growcut3D/_growcut3D_cy.pyx":114
 *                                         state_next_arr[i, j, k, 0] = state_arr[ii, jj, kk, 0]
 * 
 *                                         changes += 1             # <<<<<<<<<<<<<<
 *                                         changes_per_cell += 1
 ...
 */
                    ...
                    /* "growcut3D/_growcut3D_cy.pyx":115
 * 
 *                                         changes += 1
 *                                         changes_per_cell += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "growcut3D/_growcut3D_cy.pyx":117
 *                                         changes_per_cell += 1
 * 
 *         state_arr[:] = state_next_arr[:]             # <<<<<<<<<<<<<<
 *         print changes
 * 
 */
    if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_state_next_arr, __pyx_v_state_arr, 4, 4, 0) < 0)) __PYX_ERR(0, 117, __pyx_L1_error)

    /* "growcut3D/_growcut3D_cy.pyx":118
 * 
 *         state_arr[:] = state_next_arr[:]
 *         print changes             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_3 = PyInt_FromSsize_t(__pyx_v_changes); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 118, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    if (__Pyx_PrintOne(0, __pyx_t_3) < 0) __PYX_ERR(0, 118, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  }

  /* "growcut3D/_growcut3D_cy.pyx":120
 *         print changes
 * 
 *     return np.asarray(state_arr[:, :, :, 0])             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_asarray); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_54.data = __pyx_v_state_arr.data;
  __pyx_t_54.memview = __pyx_v_state_arr.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_54, 0);
  __pyx_t_54.shape[0] = __pyx_v_state_arr.shape[0];
__pyx_t_54.strides[0] = __pyx_v_state_arr.strides[0];
    __pyx_t_54.suboffsets[0] = -1;

__pyx_t_54.shape[1] = __pyx_v_state_arr.shape[1];
__pyx_t_54.strides[1] = __pyx_v_state_arr.strides[1];
    __pyx_t_54.suboffsets[1] = -1;

__pyx_t_54.shape[2] = __pyx_v_state_arr.shape[2];
__pyx_t_54.strides[2] = __pyx_v_state_arr.strides[2];
    __pyx_t_54.suboffsets[2] = -1;

{
    Py_ssize_t __pyx_tmp_idx = 0;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_state_arr.shape[3];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_state_arr.strides[3];
...
__pyx_t_1 = __pyx_memoryview_fromslice(__pyx_t_54, 3, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  if (!__pyx_t_2) {
    __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_6, __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 120, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_GOTREF(__pyx_t_3);
  } else {
    ...
    __pyx_t_1 = 0;
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_4, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 120, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  }
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "growcut3D._growcut3D_cy.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "growcut3D._growcut3D_cy.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "growcut3D._growcut3D_cy.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "growcut3D._growcut3D_cy._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_C_Users_Edson_Cavalcanti_Dropbox, __pyx_k_C_Users_Edson_Cavalcanti_Dropbox, sizeof(__pyx_k_C_Users_Edson_Cavalcanti_Dropbox), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_growcut3D__growcut3D_cy, __pyx_k_growcut3D__growcut3D_cy, sizeof(__pyx_k_growcut3D__growcut3D_cy), 0, 0, 1, 1},
 ...
 *     """Grow-cut segmentation.
 */
  __pyx_tuple__20 = PyTuple_Pack(26, __pyx_n_s_image, __pyx_n_s_state, __pyx_n_s_max_iter, __pyx_n_s_window_size, __pyx_n_s_state_arr, __pyx_n_s_state_next_arr, __pyx_n_s_image_arr, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_k, __pyx_n_s_ii, __pyx_n_s_jj, __pyx_n_s_kk, __pyx_n_s_width, __pyx_n_s_height, __pyx_n_s_depth, __pyx_n_s_ws, __pyx_n_s_n, __pyx_n_s_changes, __pyx_n_s_changes_per_cell, __pyx_n_s_C_p, __pyx_n_s_S_p, __pyx_n_s_C_q, __pyx_n_s_S_q, __pyx_n_s_gc, __pyx_n_s_attack_strength); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(4, 0, 26, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_C_Users_Edson_Cavalcanti_Dropbox, __pyx_n_s_growcut3D, 40, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 40, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_growcut3D_cy(void); /*proto*/
PyMODINIT_FUNC init_growcut3D_cy(void)
#else
PyMODINIT_FUNC PyInit__growcut3D_cy(void); /*proto*/
PyMODINIT_FUNC PyInit__growcut3D_cy(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__growcut3D_cy(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_growcut3D_cy", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_growcut3D___growcut3D_cy) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "growcut3D._growcut3D_cy")) {
      if (unlikely(PyDict_SetItemString(modules, "growcut3D._growcut3D_cy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  /* "growcut3D/_growcut3D_cy.pyx":33
 * 
 * 
 ...
 * 
 */
  __pyx_v_9growcut3D_13_growcut3D_cy_s3 = sqrt(3.0);
 ...
 *     """Grow-cut segmentation.
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_9growcut3D_13_growcut3D_cy_1growcut3D, NULL, __pyx_n_s_growcut3D__growcut3D_cy); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_growcut3D, __pyx_t_2) < 0) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "growcut3D/_growcut3D_cy.pyx":1
 * #cython: cdivision=True             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init growcut3D._growcut3D_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init growcut3D._growcut3D_cy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
